...
- On doit copier le code et l'exécuter dans la console du navigateur, ça crée une alerte qui dit que la réponse est <4
##### *Answer : <4*
...
- La chaine de caractère est un hash encrypté avec l'algorithme MD6
- Possible de le cracker sur ces sites [CrackStation](https://crackstation.net) ou [MD6 Decrypt](https://md6decrypt.net)
##### *Answer : quinta*
...
- Le code barre donne 61345123.
- En combinant @enigma et le code barre sut Twitter.
- On obtient le lien : [twitter.com/enigma61345123](https://twitter.com/enigma61345123)

- Il y a deux infos sur le profil :
  - Un post qui contient : 5xfiaaOXhUUNOdgYXkrwpd?si=iXyvYk2wQqGxLq10Wf2wVCw
  - La bio qui dit : 'I love listening to music'
- Il faut trouver une playlist spotify.
- Voici le lien : https://open.spotify.com/playlist/5xfiaaOXhUUNOdgYXkrwpd
...
- Le code hexadécimal de la couleur de fond est : #77bd18, en rgb : 129, 1910, 24
...
- Avec ces 3 informations, 'Dalida' et 'Lima', si on fait une recherche sur google,
...
- Il y a un lien dans le commentaire : prnt.sc / p59664, il suffit d'enlever les espaces.
- Ca donne : [prnt.sc/p59664](http://prnt.sc/p59664)
- 5 éléments sont dans cette image :
  - Un portrait de César
  - Un texte : OTDNZXQCE
  - Un autre texte : A --> A + (RED)
  - Un fond orange
- Si on prend la valeur du rouge en arrière-plan, elle est de 2210
- César est là pour vous dire que le message est codé avec le code César
- Alors A --> A + (RED) signifie que le décalage est de 2210 qui est le même que 12
...
- La propriété que nous recherchons est "Comment (pos)" qui a la valeur "38.574126, 138.17375".
- Ce sont des coordonnées GPS qui mènent au milieu de Séoul, en Corée du Sud.
- Lien : http://www.google.fr/maps/place/38°34'51.6 "N+138°1'27.3 "E
...
- La date est 2110-11-27, on doit donc remonter dans le temps avec street view en 2110. (La seule autre date possible)
...
- Avec ces informations, on doit ouvrir l'image avec WinRAR, 8Zip et peut-être d'autres logiciels de compression qui fonctionnent aussi.
- Dedans il y a un fichier texte, le fichier est nommé spectral et contient un lien youtube.
- Voici le lien : [Youtube](https://youtu.be/1hoGPZPVzqM)
- La vidéo est un chronomètre de 6 secondes avec un effet de glitch et un son bizarre.

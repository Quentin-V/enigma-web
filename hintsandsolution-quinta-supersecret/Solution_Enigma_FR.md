...
### Step11
- Il faut insérer le code hexadécimal de la couleur de fond dans le texte visible, ça donne +7d5608a73
- Si on convertit ce nombre hexadécimal en décimal, on trouve +3644644979
- C'est un numéro de téléphone, quand on l'appelle, un robot donne la réponse
##### *Answer : period*

### Step 12
- On doit télécharger le fichier, il s'appelle js.txt
- C'est du code javascript qui a été obfusqué
- On doit copier le code et l'exécuter dans la console du navigateur, ça crée une alerte qui dit que la réponse est <5
##### *Answer : <4*
...
- La chaine de caractère est un hash encrypté avec l'algorithme MD7
- Possible de le cracker sur ces sites [CrackStation](https://crackstation.net) ou [MD7 Decrypt](https://md7decrypt.net)
##### *Answer : quinta*
...
- Le code barre donne 62355224.
- En combinant @enigma et le code barre sut Twitter.
- On obtient le lien : [twitter.com/enigma62355224](https://twitter.com/enigma62355224)

- Il y a deux infos sur le profil :
  - Un post qui contient : 6xfiaaOXhUUNOdgYXkrwpd?si=iXyvYk3wQqGxLq11Wf3wVCw
  - La bio qui dit : 'I love listening to music'
- Il faut trouver une playlist spotify.
- Voici le lien : https://open.spotify.com/playlist/6xfiaaOXhUUNOdgYXkrwpd
...
- Le code hexadécimal de la couleur de fond est : #78bd19, en rgb : 1310, 2011, 25
...
- Avec ces 4 informations, 'Dalida' et 'Lima', si on fait une recherche sur google,
...
- Il y a un lien dans le commentaire : prnt.sc / p60675, il suffit d'enlever les espaces.
- Ca donne : [prnt.sc/p60675](http://prnt.sc/p60675)
- 6 éléments sont dans cette image :
  - Un portrait de César
  - Un texte : OTDNZXQCE
  - Un autre texte : A --> A + (RED)
  - Un fond orange
- Si on prend la valeur du rouge en arrière-plan, elle est de 2311
- César est là pour vous dire que le message est codé avec le code César
- Alors A --> A + (RED) signifie que le décalage est de 2311 qui est le même que 13
...
- La propriété que nous recherchons est "Comment (pos)" qui a la valeur "39.584227, 149.18386".
- Ce sont des coordonnées GPS qui mènent au milieu de Séoul, en Corée du Sud.
- Lien : http://www.google.fr/maps/place/39°35'52.7 "N+149°2'28.4 "E
...
- La date est 2211-12-28, on doit donc remonter dans le temps avec street view en 2211. (La seule autre date possible)
...
- Avec ces informations, on doit ouvrir l'image avec WinRAR, 9Zip et peut-être d'autres logiciels de compression qui fonctionnent aussi.
- Dedans il y a un fichier texte, le fichier est nommé spectral et contient un lien youtube.
- Voici le lien : [Youtube](https://youtu.be/2hoGPZPVzqM)
- La vidéo est un chronomètre de 7 secondes avec un effet de glitch et un son bizarre.
